...
function VideoCard(props) {
    ...
    return (
        ...
        <div className=  {`flex-row card rounded-none w-full h-full cursor-pointer m-auto`}>
            ...
            <div className='flex flex-col w-[50%] mx-3 md:mx-5'>
                <Link to={`/watch/${props.id}`} className='tilteTruncate text-sm sm:text-base font-medium'>
                  {props.videoTitle}
                </Link>

                <div className='flex flex-col font-normal text-xs sm:text-xs xl:text-xs '>

                    <div className="flex flex-row items-center my-2 sm:mx-0 ">
